...
def chek_answer(message):
    if message.text=="Play":
        bot.send_message(message.chat.id,"""Ok. Now look at rules of this game. You need to guess number what I guessed in range - 1 - 10! You have 3 lifes. If you lose I kill you!Good luck!(^з^)""")
